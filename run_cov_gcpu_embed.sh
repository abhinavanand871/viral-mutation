#!/bin/bash
#SBATCH --job-name=viral-cov-embed
#SBATCH --nodes=1
#SBATCH --ntasks=1
...
#SBATCH --output=/home/aa3860/viral-mutation/slurm_logs/logs.cov.embed%j
#SBATCH --error=/home/aa3860/viral-mutation/slurm_logs/err.cov.embed%j
