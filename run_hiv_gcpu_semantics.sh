#!/bin/bash
#SBATCH --job-name=viral-hiv-semantics
#SBATCH --nodes=1
#SBATCH --ntasks=1
...
#SBATCH --output=/home/aa3860/viral-mutation/slurm_logs/logs.hiv.semantics%j
#SBATCH --error=/home/aa3860/viral-mutation/slurm_logs/err.hiv.semantics%j
