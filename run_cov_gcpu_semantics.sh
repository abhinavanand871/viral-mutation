#!/bin/bash
#SBATCH --job-name=viral-cov-semantics
#SBATCH --nodes=1
#SBATCH --ntasks=1
...
#SBATCH --output=/home/aa3860/viral-mutation/slurm_logs/logs.cov.semantics%j
#SBATCH --error=/home/aa3860/viral-mutation/slurm_logs/err.cov.semantics%j
