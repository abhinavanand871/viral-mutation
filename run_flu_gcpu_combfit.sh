#!/bin/bash
#SBATCH --job-name=viral-flu-combfit
#SBATCH --nodes=1
#SBATCH --ntasks=1
...
#SBATCH --output=/home/aa3860/viral-mutation/slurm_logs/logs.flu.combfit%j
#SBATCH --error=/home/aa3860/viral-mutation/slurm_logs/err.flu.combfit%j
