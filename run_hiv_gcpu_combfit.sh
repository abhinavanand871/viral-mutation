#!/bin/bash
#SBATCH --job-name=viral-hiv-combfit
#SBATCH --nodes=1
#SBATCH --ntasks=1
...
#SBATCH --output=/home/aa3860/viral-mutation/slurm_logs/logs.hiv.combfit%j
#SBATCH --error=/home/aa3860/viral-mutation/slurm_logs/err.hiv.combfit%j
